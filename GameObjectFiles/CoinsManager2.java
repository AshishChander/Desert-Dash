...
public class CoinsManager2{
	...
	public CoinsManager2(MainCharacter mainCharacter) {
		rand = new Random();
	...
	private Coin createCoin() {
		// if (enemyType = getRandom)
			...
			return new Coinss1(mainCharacter, ((rand.nextInt(5)+1)*1400), coin.getWidth() - 10, coin.getHeight() - 10, coin);
