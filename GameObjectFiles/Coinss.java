...
public class Coinss extends Coin {
	
	public static final int Y_LAND = 480;
	...
	public Coinss(MainCharacter mainCharacter, int posX, int width, int height, BufferedImage image) {
		this.posX = posX+200;
		this.width = width;
		this.height = height;
		this.image = image;
